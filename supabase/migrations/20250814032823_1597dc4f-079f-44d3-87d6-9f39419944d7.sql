...
DROP FUNCTION IF EXISTS public.authenticate_learner(text, text);

-- Create updated authenticate_learner function to handle password verification securely
...
-- Create admin credentials table for secure storage
